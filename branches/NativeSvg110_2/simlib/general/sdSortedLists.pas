...
type
  ...
  protected
    ...
    function IndexByID(const ALuid: integer; out Index: integer): boolean;
  public
...
var
  Index: integer;
begin
  Result := IndexByID(ALuid, Index);
end;

function TLuidList.IndexByID(const ALuid: integer;
...
begin
  ...
  begin
    Index := (Min + Max) div 2;
    case CompareInteger(GetID(List[Index]), ALuid) of
    -1: Min := Index + 1;
     0: begin
          Result := True;
          exit;
